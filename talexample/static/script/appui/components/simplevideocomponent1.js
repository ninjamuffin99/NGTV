...
define(
  "sampleapp/appui/components/simplevideocomponent1",
  [
  ...
  function (Component, Button, Label, HorizontalList, VideoSource, MediaPlayer, RuntimeContext) {
    ...
    return Component.extend({
      ...
      _onBeforeRender: function (ev) {
        ...
        player.initialiseMedia('video', "https://uploads.ungrounded.net/alternate/1249000/1249054_alternate_63775.720p.mp4?f1534807442", "video/mp4", videoContainer);
