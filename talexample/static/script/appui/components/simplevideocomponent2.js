...
define(
  "sampleapp/appui/components/simplevideocomponent2",
  [
  ...
  function (Component, Button, Label, HorizontalList, VideoSource, MediaPlayer, RuntimeContext) {
    ...
    return Component.extend({
      ...
      _onBeforeRender: function (ev) {
        ...
        player.initialiseMedia('video', "https://uploads.ungrounded.net/alternate/1241000/1241911_alternate_62757.720p.mp4?f1532623959", "video/mp4", videoContainer);
